<?php 
  if ( isset($_COOKIE["user"]) && isset($_COOKIE["auth"]) && (!isset($_GET['attempt'])) ) header('Location: interface.php');
?>
<!DOCTYPE html>
<html>
<head>
  <title>Login to Administrative Interface</title>
  <meta name="viewport"    content="width=device-width,initial-scale=1.0">
  <meta name="description" content="Administrative interface for EESA">
...
<body>
  <div style="width:50%;position:absolute;left:20%;top:200px;">  
    <h2>EESA Administrative Interface</h2>
