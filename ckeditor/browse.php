...
// e-z params  
$dir = "/ug/misc/eesa/public_html/site/news/data/images/";
$url = "https://www.ee.iitb.ac.in/course/~eesa/site/news/data/images/";
...
$url = rtrim($url, '/'); // the script will add the ending slash when appropriate  
